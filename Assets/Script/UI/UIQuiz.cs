...
public class UIQuiz : MonoBehaviour
{
    ...
    void Start()
    {
        UIconfirm(TestManager.GetInstance().quiztype);       
    }

    #region SetQuizUI
    private void UIconfirm(Quiz quiztype)
    {
        var quizmanager = TestManager.GetInstance();
    ...
    private void UIUpdate()
    {
        ...
        {
            ResultManager.GetInstance().quizcount++;
    ...
    public void OnClickAnswer(int a)
    {
        ...
        {
            ResultManager.GetInstance().CorrectCount++;
            ResultManager.GetInstance().AddScores(realQuiz.correctScore);
        }
        curNum++;
